...
class Node extends EventTarget_1.default {
    ...
    get parentElement() {
        ...
        while (parent && parent.nodeType !== NodeTypeEnum_1.default.elementNode) {
     ...
     */
    contains(otherNode) {
        return NodeUtility_1.default.isInclusiveAncestor(this, otherNode);
    }
    /**
     ...
     */
    appendChild(node) {
        return NodeUtility_1.default.appendChild(this, node);
    }
    /**
     ...
     */
    removeChild(node) {
        return NodeUtility_1.default.removeChild(this, node);
    }
    /**
    ...
    insertBefore(newNode, referenceNode) {
        ...
        return NodeUtility_1.default.insertBefore(this, newNode, referenceNode);
    }
    /**
    ...
    normalize() {
        ...
        while (child) {
            if (NodeUtility_1.default.isTextNode(child)) {
                // Append text of all following text nodes, and remove them.
                while (NodeUtility_1.default.isTextNode(child.nextSibling)) {
