...
const CharacterDataUtility_1 = __importDefault(require("../character-data/CharacterDataUtility"));
const EventPhaseEnum_1 = __importDefault(require("../../event/EventPhaseEnum"));
/**
 * Element.
 */
class Element extends Node_1.default {
    ...
    get textContent() {
        ...
        return CharacterDataUtility_1.default.decodeHTMLEntities(result);
    }
    /**
     * Sets text content.
     *
    ...
    appendChild(node) {
        ...
        return ElementUtility_1.default.appendChild(this, node);
    }
    /**
     * @override
     */
    removeChild(node) {
        // We do not call super here as this will be handled by ElementUtility to improve performance by avoiding validation and other checks.
        return ElementUtility_1.default.removeChild(this, node);
    }
    /**
     * @override
     */
    insertBefore(newNode, referenceNode) {
        ...
        // We do not call super here as this will be handled by ElementUtility to improve performance by avoiding validation and other checks.
        return ElementUtility_1.default.insertBefore(this, newNode, referenceNode);
    }
    /**
     ...
     */
    matches(selector) {
        return !!QuerySelector_1.default.match(this, selector);
    }
    /**
    ...
    closest(selector) {
        ...
        let parent = this;
        while (parent) {
            if (QuerySelector_1.default.match(parent, selector)) {
                return parent;
            }
    ...
    dispatchEvent(event) {
        ...
        if ((event.eventPhase === EventPhaseEnum_1.default.atTarget ||
