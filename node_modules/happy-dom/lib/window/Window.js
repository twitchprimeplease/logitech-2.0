...
const NodeIterator_1 = __importDefault(require("../tree-walker/NodeIterator"));
...
const CSSSupportsRule_1 = __importDefault(require("../css/rules/CSSSupportsRule"));
...
const SubmitEvent_1 = __importDefault(require("../event/events/SubmitEvent"));
...
const HTMLFormControlsCollection_1 = __importDefault(require("../nodes/html-form-element/HTMLFormControlsCollection"));
...
const AbortController_1 = __importDefault(require("../fetch/AbortController"));
const AbortSignal_1 = __importDefault(require("../fetch/AbortSignal"));
...
class Window extends EventTarget_1.default {
    ...
    constructor(options) {
        ...
        this.NodeIterator = NodeIterator_1.default;
        ...
        this.SubmitEvent = SubmitEvent_1.default;
        ...
        this.HTMLFormControlsCollection = HTMLFormControlsCollection_1.default;
        ...
        this.CSSSupportsRule = CSSSupportsRule_1.default;
        ...
        this.AbortController = AbortController_1.default;
        this.AbortSignal = AbortSignal_1.default;
        this.FormData = FormData_1.default;
        // Events
        this.onload = null;
        this.onerror = null;
    ...
    async fetch(url, init) {
        return await new Fetch_1.default({ ownerDocument: this.document, url, init }).send();
    }
    /**
